...
urlpatterns = [
    ...
    path('api/request/', user_views.RequestAPIView.as_view(), name='request'),
    path('api/change_password/<int:pk>/', user_views.ChangePasswordView.as_view(), name='change-password'),
]